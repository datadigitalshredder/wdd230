...
fetch(templeUrl1)
    ...
    .then((jsObject) => {
            ...
            document.querySelector('#random-email1').innerHTML = templeDetails1.email;
            ...
            document.querySelector('#random-email2').innerHTML = templeDetails2.email;
            ...
            document.querySelector('#random-email3').innerHTML = templeDetails3.email;
            ...
            document.querySelector('#random-email4').innerHTML = templeDetails4.email;
            ...
            document.querySelector('#random-email4').innerHTML = templeDetails5.email;
            ...
            document.querySelector('#random-email6').innerHTML = templeDetails6.email;
