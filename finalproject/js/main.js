...
fetch(templeUrl)
    ...
    .then((jsObject) => {
        ...
        //Randomly select a temple to share details
            ...
            randomTempleDetails = templeDetails[Math.floor(Math.random() * templeDetails.length)];
            ...
            .then((jsObject) => {
                ...
                const iconsrcWeather = `https://openweathermap.org/img/w/${jsObject.weather[0].icon}.png`;
                const descWeather = jsObject.weather[0].description;
